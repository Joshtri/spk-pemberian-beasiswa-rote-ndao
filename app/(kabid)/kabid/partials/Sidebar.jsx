...
import { LogOut, LayoutDashboard, Calculator, Menu, X, ChevronRight } from "lucide-react"
import { Button } from "@/components/ui/button"
import axios from "@/lib/axios"

export default function SidebarKabid() {
          ...
          <>
            ...
            >
              <div className="p-4 border-b border-gray-700 flex items-center justify-between">
                {expanded || isMobile ? (
                  <h1 className="text-lg font-semibold">Kabid Panel</h1>
                ) : (
              ...
              <div className="p-4 border-t border-gray-700 mt-auto">
                <button
                  className="flex items-center w-full px-4 py-2 text-sm text-white bg-red-600 hover:bg-red-700 rounded-md transition-colors"
